...
class RSCDaemon(object):
    ...
    def __init__(self, ip_address='127.0.0.1', port=50105, password=None):
...
def main():
    ...
    rsc_daemon = RSCDaemon(password="rsc-test")
    rsc_daemon.add_logger(Logger())
    rsc_daemon.start()
